...
import HorizontalScollCard from "../components/HorizontalScrolling";
      ...
      <div className="container mx-auto px-3 py-16 lg:py-0 flex flex-col lg:flex-row gap-5 lg:gap-10 ">
        <div className="relative mx-auto lg:-mt-28 lg:mx-0 w-fit min-w-60">
          ...
          <button
            ...
            className="mt-3 w-full py-2 px-4 text-center bg-white text-black rounded font-bold text-lg hover:bg-gradient-to-l from-red-500 to-orange-500 hover:scale-105 transition-all border-[1px] border-black hover:border-none "
          >
            Play Now
          </button>
        </div>
